function stage = BOPointInPolygon2D(P,q)
%% BOPointInPolygon2D - find point in polygon
%   
%   REFERENCE:
%       Computational Geometry in C, Chapter 7.  
%
%   INPUT:
%       P       - input vector Nx2
...
%       P = [P; P(1,:)];
%       plot(P(:,1),P(:,2),'-bs'); hold on
%       q = P(10,:);
%       plot(q(:,1),q(:,2),'r*');
%       stage = BOPointInPolygon(P,q);
% 
%   AUTHOR:
